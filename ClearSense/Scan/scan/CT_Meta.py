...
Description.send_keys("This scan is regarding Meta")
time.sleep(5)
...
#Select Scan type
#//div[@class='p-radiobutton-box p-highlight']//span[@class='p-radiobutton-icon']   
...
Meta = driver.find_element(By.XPATH, "/html/body/p-dynamicdialog/div/div/div[2]/app-create-scan/div/app-scan-information/form/div[1]/div[5]/div[2]/p-selectbutton/div/div[2]/span") 
Meta.click()

Custom_url=driver.find_element(By.XPATH, "//input[@placeholder='https://www.customTrackingURL.com']") 
Custom_url.send_keys("https://www.cleartrust.biz")
