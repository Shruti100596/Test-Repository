...
Description.send_keys("This scan is regarding Google")
time.sleep(90)
...
Tag.send_keys("Google Tracking, #Sportsphere website")
time.sleep(10)
...
#Select google type
#Google_Macro = driver.find_element(By.XPATH, "//p-radiobutton[@class='p-element mr-2 ng-valid ng-dirty ng-touched']//div[@class='p-radiobutton p-component p-radiobutton-checked']//span[@class='p-radiobutton-icon']") 
#Google_Macro.click()
#time.sleep(3)
