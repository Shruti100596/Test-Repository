...
Scan_Name.send_keys("Postback Scan")
time.sleep(3)
...
Description.send_keys("This scan is regarding Postback")
time.sleep(5)
...
Tag.send_keys("CT Postback-Scan")
time.sleep(10)

#Select Scan type
radio_button = driver.find_element(By.XPATH, "/html/body/p-dynamicdialog/div/div/div[2]/app-create-scan/div/app-scan-information/form/div[1]/div[5]/div[1]/div[6]/p-radiobutton/div/div[2]") 
radio_button.click()
time.sleep(5)

#Selecting Postback
Adjust= driver.find_element(By.XPATH, "/html/body/p-dynamicdialog/div/div/div[2]/app-create-scan/div/app-scan-information/form/div[1]/div[5]/div[2]/div[2]/p-radiobutton/div/div[2]")
Adjust.click()

#Select Inventory
Select_Inventory=WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.XPATH,"/html/body/p-dynamicdialog/div/div/div[2]/app-create-scan/div/app-scan-information/form/div[1]/div[5]/div[3]/div/p-dropdown/div/div[2]s"))
)
