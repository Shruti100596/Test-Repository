...
Scan_Name.send_keys("Taboola_scan")
time.sleep(3)
...
Description.send_keys("This scan is regarding Taboola without Custom Domain")
time.sleep(10)
...
Tag.send_keys("Taboola-Scan, #Sportsphere website")
time.sleep(10)

#SelectRedirect link Scan type 
...
#Select Taboola Scan type
try:
    # Wait for the element to be present and visible
    taboola_button = WebDriverWait(driver, 20).until(
    ...
    # Scroll into view
    driver.execute_script("arguments[0].scrollIntoView(true);", taboola_button)

    # Click using ActionChains
    actions = ActionChains(driver)
    actions.move_to_element(taboola_button).click().perform()
    print("Radio button clicked successfully.")
except Exception as e:
    print("Error interacting with the radio button:", e)
