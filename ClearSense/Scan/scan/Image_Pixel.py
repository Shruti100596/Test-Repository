...
Scan_Name.send_keys("Image-Pixel Scan")
time.sleep(3)
...
Description.send_keys("This scan is regarding Image-Pixel Scan")
time.sleep(5)
...
Tag.send_keys("CT Image Pixel-Scan")
time.sleep(10)
...
try:
    ...
    radio_button = WebDriverWait(driver, 10).until(
        EC.visibility_of_element_located((By.XPATH, "/html/body/p-dynamicdialog/div/div/div[2]/app-create-scan/div/app-scan-information/form/div[1]/div[5]/div[1]/div[5]/p-radiobutton/div/div[2]"))
    )
    # Scroll into view
