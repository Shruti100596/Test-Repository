...
def run_create_branchoffer_club():
    ...
    try:
        ...
        computers_electonics=anksdriver.find_element(By.XPATH, '//*[@id="pr_id_17_list"]/p-dropdownitem[4]/li/span')

        computers_electonics.click()
        time.sleep(3)
        ...
        laptops_1 = anksdriver.find_element(By.XPATH,'//*[@id="pr_id_18_list"]/p-dropdownitem[2]/li/span')
        laptops_1.click()
        time.sleep(5)
        ...
        branch_platform = anksdriver.find_element(By.XPATH,'//*[@id="pr_id_19_list"]/p-dropdownitem[4]/li')
        branch_platform .click()
        time.sleep(3)
        ...
        copy_button = anksdriver.find_element(By.XPATH,'/html/body/p-dynamicdialog/div/div/div[2]/app-offer-details/div[1]/div[1]/div[2]/div[1]/div/p-button/button/span ')
        copy_button.click()
        time.sleep(5)
