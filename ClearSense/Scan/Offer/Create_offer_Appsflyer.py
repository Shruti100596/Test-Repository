...
def run_createoffer_club():
    ...
    try:
        ...
        end_date.click()
        time.sleep(2)
        end_date_click = anksdriver.find_element(By.XPATH,'/html/body/app-root/app-layout/main/div/div[2]/app-create-offer/div/div/div[1]/form/p-accordion/div/p-accordiontab[1]/div/div[2]/div/div[3]/div[2]/p-calendar/span/div/div/div/div[1]/button[2]')
        end_date_click.click()
        time.sleep(3)
        end_date_select=anksdriver.find_element(By.XPATH,'/html/body/app-root/app-layout/main/div/div[2]/app-create-offer/div/div/div[1]/form/p-accordion/div/p-accordiontab[1]/div/div[2]/div/div[3]/div[2]/p-calendar/span/div/div/div/div[2]/table/tbody/tr[6]/td[1]/span')
